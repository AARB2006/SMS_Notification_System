...
<div class="content">
    ...
    <div class = "buttons">
      ...
      <button onclick="window.location.href = '' " class="delete" id="deleteBtn" 
        name = "deleteBtn" form="nameForm" disabled type="submit">Delete User</button>
        

        
        <button onclick="window.location.href = 'addUser.php' " class="add" id="addBtn" 
        name = "addBtn">Add User</button>
    ...
    <form action="userProcess.php" method="post" id="nameForm">
    <?php

    
    $usernames = get_usernamesADMIN($conn);
    display_usernamesADMIN2($usernames,$displayName);
    $conn->close();
...
document.addEventListener("DOMContentLoaded", function(){
  ...
  deleteButton.addEventListener('click', (event) => {
    ...
    const message = "Are you sure you want to delete these users?";
